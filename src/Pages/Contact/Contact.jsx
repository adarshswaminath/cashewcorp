    ...
    <main className="about ">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="grid gap-3 md:grid-cols-2 grid-cols-1 lg:grid-cols-3 mt-4">
          ...
          <div className="bg-white p-12 shadow-lg">
            <div className="flex gap-3">
              <div className="h-12 w-12 bg-red-500 flex items-center justify-center rounded-full shadow-lg">
                <AiOutlineMail className="text-2xl text-white" />
              </div>
              <div className="grid">
                <h3 className="text-red-500">Drop a line</h3>
          ...
          <div className="bg-white p-12 shadow-lg">
            <div className="flex gap-3">
              ...
              <div className="grid">
                <h3 className="text-red-500">24/7 Service</h3>
                <h3 className="font-bold">Call Us</h3>
                <span>
                  <a href="#">+1234567790</a>{" "}
                  <span className="text-red-500">(Troll Free)</span>
                </span>
                <a href="#">+9127320272</a>
              </div>
            </div>
          ...
          <div className="bg-white p-12 shadow-lg">
            <div className="flex gap-3">
              ...
              <div className="grid">
                <h3 className="text-red-500">Location</h3>
