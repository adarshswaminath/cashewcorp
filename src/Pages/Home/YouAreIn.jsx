...
const Card = ({ index }) => {
  return (
    <div className="shadow-lg bg-white bg-gradient-to-r from-red-500 to-red-500 hover:from-red-700 hover:to-red-700 text-white font-bold py-3 px-6 transform transition-transform duration-300 hover:scale-105 hover:rotate-3 hover:shadow-lg flex items-center justify-center p-4 mb-4 rounded-md">
      <a
