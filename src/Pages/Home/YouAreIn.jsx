  ...
  return (
    <div className="container mx-auto mt-12">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <Image index={0} height="26" width="w-48"/>
        <Image index={5} height="65" width="w-48"/>
        <Image index={7} height="96" width="w-48"/>
        <Image index={3} height="96" width="w-48"/>
        <Image index={4} height="96" width="w-48"/>
        <Image index={1} height="96" width="w-48"/>
        <Image index={6} height="96" width="w-48"/>
        <Image index={2} height="96" width="w-48"/>
